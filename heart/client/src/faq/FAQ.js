...
<Card>
  ...
  <Accordion.Collapse eventKey="2">
    <Card.Body>
      <p>More testing will be done to see if you are the best possible match for the patient. We may ask for another cheek swab or blood sample or we may be able to use a stored sample. Though almost all patient information is confidential, we can tell you the patient's age, gender and disease.</p>
      <p>If the patient's doctor selects you as the best donor for the patient, we will schedule an information session so you can learn more about the donation process, risks and side effects. At that time, we can also tell you the type of donation the patient's doctor has requested — either bone marrow or cells collected from the blood, (PBSC) donation.</p>
    </Card.Body>
  </Accordion.Collapse>
</Card>
</div>
...
<div>
  ...
  <Accordion.Collapse eventKey="3">
    <Card.Body>
      <p>You have the right to change your mind about being a donor at any time. Donating is always voluntary.</p>
      <p>If you decide you do not want to donate, let us know right away. We will need to continue the search for another donor without dangerous — even life-threatening — delays for the patient.</p>
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
  ...
  <Accordion.Collapse eventKey="4">
    <Card.Body>
      <p>Donating bone marrow is a surgical procedure done under general or regional anesthesia in a hospital. While a donor receives anesthesia, doctors use needles to withdraw liquid marrow from the back of the pelvic bone.</p>
      <p>PBSC donation is a non-surgical procedure done in an outpatient clinic. PBSC donors receive daily injections of a drug called filgrastim for five days, to increase the number of blood-forming cells in the bloodstream. Then, through a process called apheresis, a donor's blood is removed through a needle in one arm and passed through a machine that separates out the blood-forming cells. The remaining blood is returned to the donor through the other arm.</p>
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
...
<Card>
  ...
  <Accordion.Collapse eventKey="6">
    <Card.Body>
      <p>Donors never pay for donating, and are never paid to donate.</p>
      <p>All medical costs for the donation procedure are covered by the National Marrow Donor Program® (NMDP), which operates the Be The Match Registry®, or by the patient's medical insurance, as are travel expenses and other non-medical costs. The only costs to the donor might be time taken off from work.</p>
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
